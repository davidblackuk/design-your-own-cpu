...
public class DivideRegisterWithRegisterInstructionTests : EmulatorUnitTest
{
    [Test]
    ...
    private DivideRegisterByRegisterInstruction CreateSut(byte register, byte otherRegister)
    {
        return new DivideRegisterByRegisterInstruction(register, 0, otherRegister);
    }
}