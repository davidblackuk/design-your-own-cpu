...
# USAGE:
#
#  .\tool <assemble | run > (-quiet) Filename
#
#
#  Examples:
...
#   
param (
    # the command to run (assemble,  or run)
...
if  ( -Not ((Test-Path $AssemblerFolder) -And (Test-Path $EmulatorFolder) ))
{
    Write-Error "Missing one of the expected folders relative to this script:  $AssemblerFolder , $EmulatorFolder"
}
